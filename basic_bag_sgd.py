...
fit_data, val_data, fit_target, val_target = CV.train_test_split( recipes_train['ingredients'].values, recipes_train['cuisine'].values, test_size=0.05)
...
# Fit pipeline
print()
print("Fitting SVM classifier to training data...")
...
recipes_test.to_csv('/Users/josh/dev/kaggle/whats-cooking/sub/basic_bag_sgd.csv',index=False)
